...
metadata:
  {
    "openclaw":
      {
        "emoji": "🏨",
        "requires": { "config": ["beds24.apiKey", "beds24.apiToken"] },
        "hints":
          {
            "beds24.apiKey": "Invite code from Beds24 control panel (Settings → API → API V2)",
            "beds24.apiToken": "Access token or refresh token (use refresh token for longer validity)",
          },
      },
  }
---
